...
from repr_utils import INTERMEDIATE_DATA_FOLDER_PATH, MODELS, tensor_to_numpy, clean_str, text_statistics
...
def main(args, segs):
    ...
    dataset = {
        "raw_text": segs,
        "cleaned_text": [clean_str(s) for s in segs],
    }
    text_statistics(dataset["cleaned_text"], "cleaned_txt")

    data_folder = os.path.join(INTERMEDIATE_DATA_FOLDER_PATH, args.theme, args.title)
